                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item {{ request()->is('West Depot') ? 'active' : '' }}"  href="#">West Depot</a>
                                    <a class="dropdown-item {{ request()->is('East Depot') ? 'active' : '' }}"  href="#">East Depot</a>
                                    <a class="dropdown-item {{ request()->is('OCC') ? 'active' : '' }}"  href="#">OCC</a>
                                    <a class="dropdown-item {{ request()->is('FM') ? 'active' : '' }}" href="#">FM Department</a>
                                    <a class="dropdown-item {{ request()->is('Sales & Marketing') ? 'active' : '' }}" href="#">Sales & Marketing</a>
                                    <a class="dropdown-item {{ request()->is('Training') ? 'active' : '' }}" href="#">Training</a>
                                </div>
                            </li>
